...
# 读取训练集和测试集
train_df = pd.read_csv('Train_set/Corridor_data_200_train_set.csv')
test_df = pd.read_csv('Test_set/Corridor_data_200_test_set.csv')

# 假设前10列是特征，最后一列是标签
X_train = train_df.iloc[:, 0:-7].values
